<h2>1392. Longest Happy Prefix</h2><h3>Hard</h3><hr><div><p>A string is called a&nbsp;<em>happy prefix</em>&nbsp;if is a <strong>non-empty</strong> prefix which is also a suffix (excluding itself).</p>
